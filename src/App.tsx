...
function App() {
  ...
  const handleTrack = () => {
    if (carrier === 'correios') {
      window.open(`https://rastreamento.correios.com.br/app/index.php?objeto=CÓDIGO_DE_RASTREIO`, '_blank');
        ...
        <div className="max-w-4xl mx-auto px-4 h-full flex flex-col items-center justify-center">
          ...
          <div className="mt-8 text-white text-center">
            <p className="text-sm opacity-80">
              Exemplos de códigos: Correios (AA123456789BR) | Jadlog (12345678912345) BY NINEX
            </p>
          </div>
        </div>
      </div>
